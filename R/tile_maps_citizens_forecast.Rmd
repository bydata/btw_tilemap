...
ggsave(here("plots", "grid_map_de.pdf"), width = 10, height = 13, device = cairo_pdf)

## Englische Version
g + labs(title = title_en, caption = caption_en) +
  scale_color_manual(values = c(party_colors, c("Kopf-an-Kopf" = "grey85")),
                     name = NULL, labels = parties_en)
ggsave(here("plots", "grid_map_en.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "grid_map_de_v2.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "grid_map_en_v2.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
## Deutsche Version
g + labs(title = title_de, caption = caption_de)
ggsave(here("plots", "bubble_map_de.pdf"), width = 10, height = 13, device = cairo_pdf)

## Englische Version
g + labs(title = title_en, caption = caption_en) +
  scale_color_manual(values = c(party_colors, c("Kopf-an-Kopf" = "grey85")),
                     name = NULL, labels = parties_en)
ggsave(here("plots", "bubble_map_en.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_de_v2.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "bubble_map_en_v2.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "grid_map_diff_de.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "grid_map_diff_en.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_diff_de.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "bubble_map_diff_en.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_t_test_de.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "bubble_map_t_test_en.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_states.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_diff_bland_mark.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_diff_location_highlights.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "bubble_map_diff_location_highlights_ggforce.pdf"), width = 10, height = 13, device = cairo_pdf)
```
...
ggsave(here("plots", "hexagon_map_diff_de.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "hexagon_map_diff_en.pdf"), width = 10, height = 13, device = cairo_pdf)
``` 
...
ggsave(here("plots", "hexagon_map_t_test_de.pdf"), width = 10, height = 13, device = cairo_pdf)
...
ggsave(here("plots", "hexagon_map_t_test_en.pdf"), width = 10, height = 13, device = cairo_pdf)
``` 
