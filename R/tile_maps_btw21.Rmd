...
g_tile_winner_id + labs(title = title_en, subtitle = subtitle_second_en, caption = caption_en) +
  scale_color_manual(values = party_colors_first, name = NULL, labels = parties_second_en)
...
g_tile_diff_id <- g_tile_diff +
  geom_text(
    data = filter(grid_btw, difference_second_percent > 15),
    aes(label = id, color = winner_second_de,
        color = after_scale(lighten(color, .65))),
    size = 3.2, family = "Chivo", fontface = "bold", 
    show.legend = FALSE
...
g_tile_diff_id <- g_tile_diff +
  geom_text(
    data = filter(grid_btw, winner_second_percent > 15),
    aes(label = id, color = winner_second_de,
        color = after_scale(lighten(color, .65))),
    size = 3.2, family = "Chivo", fontface = "bold", 
    show.legend = FALSE
